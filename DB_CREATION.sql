--------------------------------------------------------
--  Arquivo criado - Quarta-feira-Julho-03-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for View NW_CLIENTE
--------------------------------------------------------

  CREATE OR REPLACE FORCE VIEW "NW_CLIENTE" ("NOME_CLIENTE", "COD_CLIENTE") AS 
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table DIMDATA
--------------------------------------------------------

  CREATE TABLE "DIMDATA" 
   (	"ID_MES" NUMBER(4,0), 
	"MES" VARCHAR2(14 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table DIMEDITORA
--------------------------------------------------------

  CREATE TABLE "DIMEDITORA" 
   (	"EDITORA_ID" NUMBER(4,0), 
	"NOME_EDITORA" VARCHAR2(60 BYTE), 
	"PAISEDITORA" VARCHAR2(60 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table DIMLIVRO
--------------------------------------------------------

  CREATE TABLE "DIMLIVRO" 
   (	"LIVRO_ID" NUMBER(4,0), 
	"TITULO" VARCHAR2(120 BYTE), 
	"SITUACAO" VARCHAR2(120 BYTE), 
	"NOME_AUTOR" VARCHAR2(120 BYTE), 
	"CAPA" VARCHAR2(60 BYTE), 
	"PAPEL" VARCHAR2(60 BYTE)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE TABLE "VENDAFATO" 
   (	"CPF" NUMBER(11,0), 
	...
	"MARGEMDELUCRO" NUMBER(10,2), 
	"FATURAMENTO" NUMBER(10,2), 
	"PERCENTUALDELUCRO" NUMBER(10,2)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "SEQ_AUDIT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
REM INSERTING into DIMCLIENTE
SET DEFINE OFF;
Insert into DIMCLIENTE (CPF,NOME) values ('33147298710','Miguel Costa Correia');
Insert into DIMCLIENTE (CPF,NOME) values ('33539424598','Rafael Carvalho Martins');
Insert into DIMCLIENTE (CPF,NOME) values ('5559121916','Brenda Rodrigues Souza');
Insert into DIMCLIENTE (CPF,NOME) values ('72111314897','Rafael Nonino Filho');
Insert into DIMCLIENTE (CPF,NOME) values ('24262676668','Vinícius Goncalves Ribeiro');
Insert into DIMCLIENTE (CPF,NOME) values ('40765290227','Eric Maycon da Conceição Pessoa');
Insert into DIMCLIENTE (CPF,NOME) values ('61516549198','Luiz Gomes Melo');
Insert into DIMCLIENTE (CPF,NOME) values ('73464371875','Victor Hugo Negrisoli');
Insert into DIMCLIENTE (CPF,NOME) values ('36121830018','Kauan Cardoso Fernandes');
Insert into DIMCLIENTE (CPF,NOME) values ('59781833505','Anna Sousa Barbosa');
Insert into DIMCLIENTE (CPF,NOME) values ('94762866016','Gabrielle Oliveira Ferreira');
Insert into DIMCLIENTE (CPF,NOME) values ('43496553367','Natália Cristina Martins de Sá');
Insert into DIMCLIENTE (CPF,NOME) values ('81553687779','Rodrigo Araujo Ferreira');
REM INSERTING into DIMDATA
SET DEFINE OFF;
Insert into DIMDATA (ID_MES,MES) values ('1','Janeiro');
Insert into DIMDATA (ID_MES,MES) values ('2','Fevereiro');
Insert into DIMDATA (ID_MES,MES) values ('3','Março');
Insert into DIMDATA (ID_MES,MES) values ('4','Abril');
Insert into DIMDATA (ID_MES,MES) values ('5','Maio');
Insert into DIMDATA (ID_MES,MES) values ('6','Junho');
Insert into DIMDATA (ID_MES,MES) values ('7','Julho');
Insert into DIMDATA (ID_MES,MES) values ('8','Agosto');
Insert into DIMDATA (ID_MES,MES) values ('9','Setembro');
Insert into DIMDATA (ID_MES,MES) values ('10','Outubro');
Insert into DIMDATA (ID_MES,MES) values ('11','Novembro');
Insert into DIMDATA (ID_MES,MES) values ('12','Dezembro');
REM INSERTING into DIMEDITORA
SET DEFINE OFF;
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('1','Panini Comics Brasil','Brasil');
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('2','DC Comics','Estados Unidos da América');
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('5','Editora Gutenberg','Brasil');
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('6','Editora Cia dos Livros','Brasil');
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('8','Editora HarperCollins Brasil','Brasil');
Insert into DIMEDITORA (EDITORA_ID,NOME_EDITORA,PAISEDITORA) values ('10','Editora Martins Fontes','Brasil');
REM INSERTING into DIMLIVRO
SET DEFINE OFF;
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('1','O Homem de Aço','Em Estoque','John Byrne','Capa Cartonada','Papel LWC');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('2','Man of Steel','Indisponível','Alan Moore','Capa Cartonada','Papel LWC');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('3','Watchmen','Em Estoque','Alan Moore','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('4','A Piada Mortal','Em Estoque','Alan Moore','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('5','Final Crisis','Indisponível','Grant Morrison','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('6','Multiverso','Em Estoque','Grant Morrison','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('7','JLA: New World Order','Indisponível','Grant Morrison','Capa Cartonada','Papel LWC');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('8','Crise Final','Em Estoque','Grant Morrison','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('9','Superman: Origem Secreta','Em Estoque','Geoff Johns','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('10','Crise Infinita','Indisponível','Geoff Johns','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('11','Liga da Justiça: A Guerra da Trindade','Em Estoque','Geoff Johns','Capa Cartonada','Papel LWC');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('12','DC: Renascimento','Em Estoque','Geoff Johns','Brochura','Papel LWC');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('13','O Reino do Amanhã','Em Estoque','Mark Waid','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('14','Superman Birthright','Indisponível','Geoff Johns','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('15','Minha Vida Fora de Série','Em Estoque','Paula Pimenta','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('16','Minha Vida Fora de Série 2','Em Estoque','Paula Pimenta','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('17','Minha Vida Fora de Série 3','Em Estoque','Paula Pimenta','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('18','Minha Vida Fora de Série 4','Em Estoque','Paula Pimenta','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('23','Box Sherlock Holmes - 4 Volumes','Em Estoque','Arthur Conan Doyle','Capa Dura','Papel Couché');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('24','O Senhor dos Anéis - A Sociedade do Anel','Em Estoque','J. R. R Tolkien','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('25','O Senhor dos Anéis - As Duas Torres','Em Estoque','J. R. R Tolkien','Brochura','Papel Pólen');
Insert into DIMLIVRO (LIVRO_ID,TITULO,SITUACAO,NOME_AUTOR,CAPA,PAPEL) values ('26','O Senhor dos Anéis - O Retorno do Rei','Em Estoque','J. R. R Tolkien','Brochura','Papel Pólen');
...
REM INSERTING into VENDAFATO
SET DEFINE OFF;
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('73464371875
0,7');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','24','10','32,5','9,9','5','2010','2','45,2','65','0,7');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('73464371875','3','1','110','55,5','3','2015','2','109','220','0,5');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('81553687779','8','1','96','55','6','2015','2','82','192','0,43');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('5559121916','9','1','55','16,5','5','2015','2','77','110','0,7');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('5559121916','13','1','71,9','30,5','3','2013','2','82,8','143,8','0,58');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','18','5','39,9','10,5','5','2017','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('73464371875','23','8','124','56','1','2017','2','136','248','0,55');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('40765290227','3','1','110','55,5','12','2015','2','109','220','0,5');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('81553687779','8','1','96','55','7','2015','2','82','192','0,43');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('5559121916','13','1','71,9','30,5','1','2013','4','165,6','287,6','0,58');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','15','5','39,9','10,5','5','2011','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33539424598','15','5','39,9','10,5','4','2011','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','15','5','39,9','10,5','4','2011','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','15','5','39,9','10,5','2','2011','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('43496553367','16','5','39,9','10,5','4','2013','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('40765290227','17','5','39,9','10,5','5','2017','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('73464371875','18','5','39,9','10,5','5','2018','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('61516549198','18','5','39,9','10,5','6','2017','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('40765290227','15','5','39,9','10,5','5','2011','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('73464371875','15','5','39,9','10,5','4','2015','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('61516549198','16','5','39,9','10,5','4','2014','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('33147298710','16','5','39,9','10,5','4','2013','4','117,6','159,6','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('43496553367','17','5','39,9','10,5','9','2015','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('61516549198','18','5','39,9','10,5','7','2018','2','58,8','79,8','0,74');
Insert into VENDAFATO (CPF,LIVRO_ID,EDITORA_ID,VALOR,CUSTO,ID_MES,ANO_ID,QUANTIDADE,MARGEMDELUCRO,FATURAMENTO,PERCENTUALDELUCRO) values ('43496553367','18','5','39,9','10,5','5','2017','2','58,8','79,8','0,74');
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C0044532
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C0044532" ON "DIMCLIENTE" ("CPF") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C0044536
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C0044536" ON "DIMDATA" ("ID_MES") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C0044525
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C0044525" ON "DIMEDITORA" ("EDITORA_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Index SYS_C0044514
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYS_C0044514" ON "DIMLIVRO" ("LIVRO_ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
/
--------------------------------------------------------
--  Constraints for Table DIMCLIENTE
--------------------------------------------------------

  ALTER TABLE "DIMCLIENTE" ADD PRIMARY KEY ("CPF")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table DIMDATA
--------------------------------------------------------

  ALTER TABLE "DIMDATA" ADD PRIMARY KEY ("ID_MES")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table DIMEDITORA
--------------------------------------------------------

  ALTER TABLE "DIMEDITORA" ADD PRIMARY KEY ("EDITORA_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Constraints for Table DIMLIVRO
--------------------------------------------------------

  ALTER TABLE "DIMLIVRO" ADD PRIMARY KEY ("LIVRO_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table VENDAFATO
--------------------------------------------------------

  ALTER TABLE "VENDAFATO" ADD FOREIGN KEY ("CPF")
	  REFERENCES "DIMCLIENTE" ("CPF") ENABLE;
  ALTER TABLE "VENDAFATO" ADD FOREIGN KEY ("LIVRO_ID")
	  REFERENCES "DIMLIVRO" ("LIVRO_ID") ENABLE;
  ALTER TABLE "VENDAFATO" ADD FOREIGN KEY ("EDITORA_ID")
	  REFERENCES "DIMEDITORA" ("EDITORA_ID") ENABLE;
  ALTER TABLE "VENDAFATO" ADD FOREIGN KEY ("ID_MES")
	  REFERENCES "DIMDATA" ("ID_MES") ENABLE;
